...
import com.example.tubesPBW.repository.PelangganRepository;
...
public class UserController {
    ...
    @GetMapping("/signup")
    public String signup(Pelanggan pelanggan) {
        pelanggan.setRole("member"); // Set role pelanggan menjadi "member"
